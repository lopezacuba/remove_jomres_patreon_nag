	...
	class j16000showplugins
	{
		public function __construct()
		{
			...
			foreach ($remote_plugins as $rp) {
				...
				$r[ 'INSTALL' ] = '<button type="button"  onclick="install_plugin(\''.$rp[ 'name' ].'\');" class="btn btn-primary"  id="install_button_content_'.$rp[ 'name' ].'" >'.$r[ 'INSTALL_TEXT' ].'</button>';
			...
			if (!empty($plugins_needing_upgrading)) {
